HPC_MANAGER_SYSTEM_PROMPT = """
                ...
                1. run_lammps(input_file) - execute LAMMPS simulation  
                2. Report simulation status and results
                3. run_all_lammps_displacements() - runs all displacements in parallel when calculating phonon dispersion
